...
broken line";
		...
		public void StringsAreReallyImmutable ()
		{
			...
			strA += strB;
			Assert.AreEqual (strA.Remove(originalString.Length, strB.Length), originalString, "'Be yourself. The world worships the original.' - Jacques Cocteau");
		...
		public void ABetterWayToConcatenateLotsOfStrings ()
		{
			...
			Assert.AreEqual (strBuilder.Length, str.Length, "When Charles M. Schulz drew Charlie Brown's screams (AAAARGH!) - did he ever wonder if he mispelled them?");
