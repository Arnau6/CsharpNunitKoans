...
namespace TheKoans
{
	...
	public class K020_AboutVariables : KoanHelper
	{
		...
		public void ImplicitAssignmentBasedOnAnotherVariable ()
		{
			...
			Assert.AreEqual (typeof(Int64), myNum.GetType (), "The apple does not fall far from the tree.  Neither does the type of the long variable you pulled the value from.");
		...
		public void ImplicitAssignmentBasedOnExpressionResults ()
		{
			...
			Assert.AreEqual (typeof(Int64), myTotal.GetType (), "An int and a long walk into a bar... And their baby is a...");
		}
		...
		public void ExplicitAssignmentByCasting ()
		{
			...
			Assert.AreEqual (typeof(Int16), canDoThis.GetType (), "Do not be short on patience. Your path to enlightenment is a process, not a destination.");
